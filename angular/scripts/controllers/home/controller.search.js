...
angular
  ...
  .controller('searchCtrl', ['$scope', '$timeout', '$filter', '$stateParams', 'headerHelp', 'catesService', 'searchService', function ($scope, $timeout, $filter, $stateParams, headerHelp, catesService, searchService) {
